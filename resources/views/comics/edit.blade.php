            ...
            <div class="card p-4 shadow-sm bg-light border-0 rounded">
                ...
                <form action="{{ route('comics.update', ['comic' => $comic->id]) }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="sale_date" id="sale_date" class="form-control" placeholder="Inserisci la data di vendita" value="{{ $comic->sale_date }}">
                    </div>
                    <div class="mb-3">
                        <label for="type" class="form-label">Tipologia</label>
                        <input type="text" name="type" id="type" class="form-control" placeholder="Inserisci la tipologia" value="{{ $comic->type }}">
                    </div>
                    <div class="mb-3">
                        <label for="artists" class="form-label">Artisti</label>
                        <textarea name="artists" id="artists" class="form-control" placeholder="Inserisci gli artisti">{{ $comic->artists }}</textarea>
                    </div>
                    <div class="mb-3">
                        <label for="writers" class="form-label">Scrittori</label>
                        <textarea name="writers" id="writers" class="form-control" placeholder="Inserisci gli scrittori">{{ $comic->writers }}</textarea>
                    </div>
